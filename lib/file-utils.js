...
const createFileDocument = async (
  ...
  console.log("=== createFileDocument ===");
  console.log("file:", JSON.stringify(file, null, 2));
  console.log("fileType:", fileType);
  console.log("uploadMethod:", uploadMethod);
  console.log("hpcInfo:", JSON.stringify(hpcInfo, null, 2));
  ...
  if (uploadMethod === "hpc-mv") {
    ...
    console.log("HPC relativePath:", relativePath);
    console.log("HPC_TRANSFER_DIRECTORY:", process.env.HPC_TRANSFER_DIRECTORY);
...
async function processSingleReadFile(file, runId, runPath, uploadInfo) {
  ...
  const readData = {
    run: runId,
    MD5: originalMd5, // Uppercase to match schema
    file: savedFile._id,
